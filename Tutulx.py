...
class Tutul:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.040)
Tutul('\033[97;1m[\033[92;1m+\033[97;1m] \033[10;92mToOLs Off-!❌ ')
time.sleep(5)
Tutul('\033[97;1m[\033[92;1m+\033[97;1m] \033[10;93mFOLLOW MY GROUP ')
os.system(f'xdg-open https://github.com/Tutul-King/')
time.sleep(7)
Tutul("\033[97;1m[\033[92;1m+\033[97;1m] \033[10;92mJOIN MY SCRIPT GIFT GROUP")
time.sleep(5)
